            ...
            <div class="row">
                <div class="col-md-6">    
                    <div class="box-header">
                        <h3 class="box-title">Congratulations, you've successfully installed Ommune EMA!</h3>
                    </div>                
                        You need to remove the install folder.<br />
                        The install folder location is: "<code><?php echo "";?>/install</code>"<br />
                        After you remove the install folder, you can login in the <a href="{{ url('/') }}">backend</a> and configure your new system.
                        <br /><br />
